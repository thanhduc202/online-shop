<%-- 
    Document   : signup
    Created on : Oct 30, 2022, 11:11:35 PM
    Author     : thanh
--%>
        ...
        <div class="register-photo">
            <div class="form-container">               
                <form method="post" action="change">
                    ...
                    <div class="form-group"><input class="form-control" type="password" name="opass" placeholder="Old password" value=""></div>
                    ...
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Change</button></div><a href="home" class="already">You don't want change Password? Back here.</a>
                </form>
            </div>
        </div>
