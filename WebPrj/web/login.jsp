        ...
        <div class="register-photo">
            <div class="form-container">               
                <form method="post" action="login">
                    ...
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Login</button></div><a href="signup" class="already">You don't have an account? Sign up here.</a>
                </form>
            </div>
        </div>
